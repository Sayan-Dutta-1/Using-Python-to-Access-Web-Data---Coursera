...
similar to http://www.py4e.com/code3/urllink2.py. The program will use urllib to read the HTML from the 
data files below, and parse the data, extracting numbers and compute the sum of the numbers in the file.
...
Actual data: http://py4e-data.dr-chuck.net/comments_1821677.html (Sum ends with 51)
...
link= "http://py4e-data.dr-chuck.net/comments_1821677.html"
